...
# NAT Gateway for private subnets' outbound internet traffic
...
resource "aws_nat_gateway" "nat_gw" {
  ...
  # Good practice: Ensure IGW is created before NAT Gateway to avoid boot issues
...
# --- TIER 1: Public Subnets (Frontend / Web / ALB) ---
...
# --- Private Route Table (DB Subnets) ---
...
# Private DB Subnets Associations
